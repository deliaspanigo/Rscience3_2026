## Segmento del UI
modules_03_tablas_02_Tablas1C_UI <- function(id) {
  ns <- NS(id)
...
## Segmento del server
modules_03_tablas_02_Tablas1C_SERVER <- function(input, output, session, 
                            minibase, 
                            batalla_naval,
                            decimales) {
  ...
  check_ok <- reactive({
    ...
    req(batalla_naval()[[4]], batalla_naval()[[4]] == 2)
  ...
  observeEvent(list(Reactive_tabla_1c_RMedic(), cantidad_tablas()), {
    # print("HOLA 04 - 02")
  ...
  output$SeccionTablas1C <- renderUI({
    ...
    div(
      h2_mod("RMedic - Tablas para 1 Variable Numérica"),
      tabsetPanel(id = ns("Tablas_1c"),
                  tabPanel("RMedic Help!", value = 1,
                           fluidRow(
                             column(4,
                                    radioButtons(inputId = ns("help_tablas_1c"),
                             ...
                             column(8,
                                    br(),
                                    conditionalPanel(condition = "input.help_tablas_1c == 1",   ns = ns,
                                                     div(
                                                       h3_mod("RMedic Here!"),
                                                       HTML(
                      ...
                      aplicadas en tu trabajo."
                                    ...
                                    conditionalPanel(condition = "input.help_tablas_1c == 2", ns = ns,
                                                     div(
                                                       h3("Medidas Resumen"),
                                                       HTML(
                      ...
                      En este caso RMedic detalla media, desvío estándard y n.<br/>"
                                    ...
                                    conditionalPanel(condition = "input.help_tablas_1c == 3", ns = ns,
                                                     div(
                      ...
                      La variable debe contener al menos un datos."
                                    ...
                                    conditionalPanel(condition = "input.help_tablas_1c == 4", ns = ns,
                                                     div(
                      ...
                      La variable debe contener al menos dos datos.")
                                    ...
                                    conditionalPanel(condition = "input.help_tablas_1c == 5", ns = ns,
                                                     div(
                                    ...
                                    conditionalPanel(condition = "input.help_tablas_1c == 6", ns = ns,
                                                     div(
