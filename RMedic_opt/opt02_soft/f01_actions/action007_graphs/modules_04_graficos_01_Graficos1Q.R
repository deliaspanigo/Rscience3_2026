## Segmento del UI
modules_04_graficos_01_Graficos1Q_UI <- function(id) {
  ns <- NS(id)
...
## Segmento del server
modules_04_graficos_01_Graficos1Q_SERVER <- function(input, output, session, 
                              minibase, 
                              casoRMedic,
                              caso,
  ...
  output$SeccionGraficos1Q <- renderUI({
    ...
    div(
      h2_mod("RMedic - Gráficos para 1 Variable Categórica"),
