## Segmento del UI
modules_04_graficos_03_Graficos2Q_UI <- function(id) {
  ns <- NS(id)
...
## Segmento del server
modules_04_graficos_03_Graficos2Q_SERVER <- function(input, output, session, 
                              minibase,
                              casoRMedic,
                              caso,
                              decimales,
  ...
  output$SeccionGraficos2Q <- renderUI({
    ...
    div(
      h2_mod("RMedic - Gráficos para 2 Variables Categóricas"),
