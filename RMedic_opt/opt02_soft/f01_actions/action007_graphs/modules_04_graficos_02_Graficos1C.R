## Segmento del UI
modules_04_graficos_02_Graficos1C_UI <- function(id) {
  ns <- NS(id)
...
## Segmento del server
modules_04_graficos_02_Graficos1C_SERVER <- function(input, output, session, 
                              minibase, 
                              casoRMedic,
                              caso,
                              decimales,
  ...
  output$SeccionGraficos1C <- renderUI({
    ...
    div(
      h2_mod("RMedic - Gráficos para 1 Variable Cuantitativa"),
