## Segmento del UI
modules_04_graficos_05_GraficosQC_UI <- function(id) {
  ns <- NS(id)
...
## Segmento del server
modules_04_graficos_05_GraficosQC_SERVER <- function(input, output, session, 
                              minibase,
                              casoRMedic,
                              caso,
                              decimales,
  ...
  output$SeccionGraficosQC <- renderUI({
    ...
    div(
      h2_mod("RMedic - Gráficos para 1 Variable Cualitativa y 1 Variable Cuantitativa"),
