## Segmento del UI
modules_04_graficos_04_Graficos2C_UI <- function(id) {
  ns <- NS(id)
...
## Segmento del server
modules_04_graficos_04_Graficos2C_SERVER <- function(input, output, session, 
                                                  minibase,
                                                  casoRMedic,
                                                  caso,
                                                  decimales,
  ...
  output$SeccionGraficos2C <- renderUI({
    ...
    div(
      h2_mod("RMedic - Gráficos para 2 Variables Cuantitativas"),
