...
SideBarBaseUI2 <- function(id) {
  ns <- NS(id)
  
  
  # Este es el sidebarpanel completo
  div(
    selectInput(inputId = ns("sui_source"),
    ...
    conditionalPanel(
      'input.sui_source == "Ejemplos"', ns = ns,
...
# 
# MiBase01_UI2 <- function(id) {
#     ns <- NS(id)
# 
#     div(
#       fluidRow(
#         column(1),
#         column(10, dataTableOutput(ns("BaseSalida"))),
#         column(1)
#       )
#     )
#     }
...
# ## Segmento del server
# 
# SideBarBaseSERVER2 <- function(id) {
...
#     #   if (is.null(input$sui_source)) return(NULL) 
#     #   
#     #   if(input$sui_source == "Excel") { 
#     #     
...
#     #     # 1) DataSet
#     #     # library(readxl)
#     #     DataSet <- as.data.frame(readxl::read_excel(path = temporal_file,
#     #                                                 col_names= TRUE,
