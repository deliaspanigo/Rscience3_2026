## Segmento del UI
module_04_graficos_VarSelector_UI <- function(id) {
  ns <- NS(id)
...
## Segmento del server
module_04_graficos_VarSelector_SERVER <- function(input, output, session, 
                               base, zocalo_CIE, 
                               verbatim) {
  ...
  # # # Opciones de seleccion de variables.
  # Interno: el nombre de cada columna
  # Externo: el detalle de la letra de la columna - el nombre de la columna
  ...
  # R-medic esta pensado solo para 1 o 2 variables.
  # por lo que segun lo elija el usuario apareceran 1 o 2 selectores.
  # Esta observeEvent no se genera el mostrar o no el selector, sino que
  # solo actualiza al selector en cuanto a las opciones que debe mostrar.
